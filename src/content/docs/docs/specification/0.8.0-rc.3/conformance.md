...
description: "MCP Description specification v0.8.0-rc.3 — 16. Conformance."
slug: docs/specification/0.8.0-rc.3/conformance
sidebar:
  order: 16
---

:::note[Mirrored specification]
This page mirrors **16. Conformance** of the MCP Description specification **v0.8.0-rc.3**. The canonical source of truth is [`mcpdesc/mcpdesc-specification`](https://github.com/mcpdesc/mcpdesc-specification/blob/v0.8.0-rc.3/spec/draft/sections/16-conformance.md). Where this page differs from upstream, upstream wins.
:::
