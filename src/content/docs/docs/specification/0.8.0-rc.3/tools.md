---
title: "9. Tools"
description: "MCP Description specification v0.8.0-rc.3 — 9. Tools."
slug: docs/specification/0.8.0-rc.3/tools
sidebar:
  order: 9
---

:::note[Mirrored specification]
This page mirrors **9. Tools** of the MCP Description specification **v0.8.0-rc.3**. The canonical source of truth is [`mcpdesc/mcpdesc-specification`](https://github.com/mcpdesc/mcpdesc-specification/blob/v0.8.0-rc.3/spec/draft/sections/09-tools.md). Where this page differs from upstream, upstream wins.
:::
...
| `elicitations` | non-empty array\<Elicitation Declaration Object\> | No | Additional user interactions that MAY be required while fulfilling the Tool (see [Section 12](/docs/specification/0.8.0-rc.3/elicitation#12-elicitation-declarations)). |
| `deprecated` | boolean | No | Whether the tool is deprecated. |
| `_meta` | object | No | Literal MCP metadata on the Tool declaration, subject to [Section 3.5](/docs/specification/0.8.0-rc.3/document-structure#35-mcp-_meta). Since MCP 2025-06-18. |
| `security` | Security Requirement Array | No | Primitive security override. |
| `clientRequirements` | [Client Capability Requirements Object](/docs/specification/0.8.0-rc.3/capabilities#85-primitive-client-capability-requirements) | No | Unconditional minimum client capabilities required for `tools/call`; does not apply to `tools/list`. |
